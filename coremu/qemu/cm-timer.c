...
void cm_init_pit_freq(void)
{
    ...
    //cm_pit_freq = 596591 / pit_freq_suggest;

	printf("pit_freq_suggest: %d %d\n", pit_freq_suggest, cm_pit_freq);
	//exit(0);
	if(v_num == 64){
		cm_pit_freq = 1193182/ 1.25;
	}
    if(v_num ==128){//easton added, make timer slower
    	pit_freq_suggest /= 7;//adjust pit_freq_suggest, biger and biger, at most to it self
    	cm_pit_freq = 1193182 /1.5; //3;2;1.45;1.4;1.35;1.3;1.29;1.287;1.285;1.28;1.27;1.25;1.2;1.15;1.1;1;
    }
}
