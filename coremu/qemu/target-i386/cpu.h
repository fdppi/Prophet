...
#define TRIFS_TRACE_PHYSICAL_ADDRESS_MASK 0xffffffff
#define ANA_MEM_PHY_PAGE_LOG_SIZE 5

#define ANALYTICAL_MODEL_INSTRUMENT
#define ANALYTICAL_MODEL_COREMU_MODIFY

#ifdef ANALYTICAL_MODEL_INSTRUMENT
#define ANALYTICAL_MODEL_STATISTICS
//#define ANALYTICAL_MODEL_TRACE_LOG

//choose only one to instrument
//#define ANALYTICAL_MODEL_FETCH_INSTR
#define ANALYTICAL_MODEL_HELPLER_FETCH_INSTR

#ifdef ANALYTICAL_MODEL_HELPLER_FETCH_INSTR
#define ANALYTICAL_MODEL_TRANSLATE_FETCH_INSTR
#endif
...
typedef struct CPUX86State {
    ...
    CPU_COMMON //get the cpu_index from HERE
