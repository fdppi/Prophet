...
DEF_HELPER_2(fetch_instruction, void, tl, tl)
#endif

#ifdef ANALYTICAL_MODEL_HELPLER_FETCH_MEM
DEF_HELPER_2(trifs_trace_tcg_mem_ld_ubyte_after, void, tl, tl);
DEF_HELPER_2(trifs_trace_tcg_mem_ld_sbyte_after, void, tl, tl);
DEF_HELPER_2(trifs_trace_tcg_mem_ld_uword_after, void, tl, tl);
DEF_HELPER_2(trifs_trace_tcg_mem_ld_sword_after, void, tl, tl);
DEF_HELPER_2(trifs_trace_tcg_mem_ld_ulong_after, void, tl, tl);
DEF_HELPER_2(trifs_trace_tcg_mem_ld_slong_after, void, tl, tl);
DEF_HELPER_2(trifs_trace_tcg_mem_ld_quad_after, void, tl, tl);

DEF_HELPER_2(trifs_trace_tcg_mem_st_byte_after, void, tl, tl);
DEF_HELPER_2(trifs_trace_tcg_mem_st_word_after, void, tl, tl);
DEF_HELPER_2(trifs_trace_tcg_mem_st_long_after, void, tl, tl);
DEF_HELPER_2(trifs_trace_tcg_mem_st_quad_after, void, tl, tl);
#endif
